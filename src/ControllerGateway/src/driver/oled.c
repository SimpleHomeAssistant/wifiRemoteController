...
{ 
    // init i2c gpio, the default gpio port may not be same with your board, you need to change it accordingly.
    // the consts are defined in i2c_master.h
    // this is my value copied from i2c_master.h, using gpio 2 as sda and gpio 14 as scl:    
